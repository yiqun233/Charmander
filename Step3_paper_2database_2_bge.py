...
model_name = "/Users/toddzzr/MLOps/huggingface/bge-large-zh-v1.5"
...
with tqdm.tqdm(total=len(files)) as pbar:
    for fi in files:
        ...
        try:
            with Elasticsearch("https://elastic:mg8RfGAgIIJ80ts5YtLO@10.2.72.208:9200",ca_certs="./ES_certs/http_ca.crt") as es:
                bulk_data = [
                        {
                            "_index": index_name,
                            "_source": {
